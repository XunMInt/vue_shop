<template>
  <div>
    ...
    <el-card class="box-card">
      ...
      ></el-pagination>
      <!-- 添加用户对话框 -->
      <el-dialog title="提示" :visible.sync="addUserVisible" width="50%" @close="addUserClose">
        <!-- 对话框内容区 -->
        <el-form
          :model="userForm"
          status-icon
      ...
      <el-dialog title="提示" :visible.sync="editUserVisible" width="50%" @close="editUserClose">
        <!-- 对话框内容区 -->
        <el-form
          :model="editUserData"
          status-icon
